                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-10 mb-10 ml-32 sm:ml-0">
                            <div className="md:col-span-1">
                                ...
                                <ul className="space-y-4 text-xs text-gray-500">
                                    <li className='hover:underline flex items-start gap-2'><FaWhatsapp className='icon' /><a href="#">9760746380</a></li>
                                    <li className='h- hover:underline flex items-start gap-2'><BiLogoGmail className='icon' /> <a href="#">adityatiwari9410@gmail.com</a></li>
                                </ul>
                            </div>
                            ...
                            <div className="md:col-span-1">
                                ...
                                <ul className="space-y-4 text-xs text-gray-500">
                                    <li className='hover:underline md:w-[50%] sm:w-full w-[50%]'><a href="#">Delhi, Noida, Sector-72</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
