...
const Hero = () => {
  return (
    <div className='flex flex-col lg:flex-row bg-black text-white justify-center gap-20 lg:justify-around items-center h-[150vh] lg:h-screen'>
      <div className='flex flex-col text-center items-center justify-center gap-5'>
        ...
        <p className='w-[70%] mdl:w-[50%] text-[15px] font-nunito animate-fadeIn-5'>Welcome to my front-end developer portfolio. I'm a passionate and aspiring front-end developer showcasing my projects and dedication to creating engaging web experiences.</p>
